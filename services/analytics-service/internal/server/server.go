...
func New(h *handler.Handler) *Server {
	...
	{
		api.POST("/analytics/events", h.CreateEvent)
		api.GET("/analytics/events", h.ListEvents)
		api.GET("/analytics/events/:id", h.GetEvent)
		api.GET("/analytics/stats/event-types", h.CountByEventType)
	}
