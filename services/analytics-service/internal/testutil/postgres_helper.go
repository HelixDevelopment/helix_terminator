...
//
// This adapts the pattern from auth-service/internal/testutil for
// analytics-service's schema and migrations (Constitution §11.4.85).
package testutil
...
import (
	...
	"github.com/helixdevelopment/analytics-service/migrations"
)
...
// via rootless podman, applies analytics-service migrations, and
...
func StartTestPostgres(t *testing.T) (dbURL string, available bool) {
	...
	name := fmt.Sprintf("analytics-stress-%d", time.Now().UnixNano())
