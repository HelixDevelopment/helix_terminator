...
// To run for real:
//
//	podman run -d --rm --name migrate-analytics-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15501:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15501/postgres?sslmode=disable" \
