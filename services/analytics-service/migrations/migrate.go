// Package migrations embeds analytics-service's SQL schema migrations and
...
//     own tables (analytics-service declares "analytics_events" +
//     its indexes), which collide the instant a second service's
...
const Schema = "analytics_service"
...
// regression.
const migrationsTable = "analytics_service_schema_migrations"
