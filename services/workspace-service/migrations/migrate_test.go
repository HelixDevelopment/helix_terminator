...
// To run for real:
//
//	podman run -d --rm --name migrate-workspace-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15551:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15551/postgres?sslmode=disable" \
