...
// helixtrack-bridge-service. These are pure-logic utilities with no
// build-tag gating — they compile whenever test code imports them.
//
// Constitution §11.4.85 (stress + chaos test mandate) requires every
// fix or improvement to ship with full-automation stress AND chaos test
// suites. This package supplies the common plumbing: latency recording,
// percentile computation, and concurrent goroutine orchestration.
package testutil
