...
// To run for real:
//
//	podman run -d --rm --name migrate-helixtrack-bridge-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15541:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15541/postgres?sslmode=disable" \
