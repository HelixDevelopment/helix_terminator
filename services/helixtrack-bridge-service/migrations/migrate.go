// Package migrations embeds helixtrack-bridge-service's SQL schema
...
// service's real HelixTrack Core JWT client logic (internal/coreclient)
// or any handler/repository behaviour.
package migrations
...
const Schema = "helixtrack_bridge_service"
...
// regression.
const migrationsTable = "helixtrack_bridge_service_schema_migrations"
