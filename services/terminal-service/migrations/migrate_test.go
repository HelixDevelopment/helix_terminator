...
// To run for real:
//
//	podman run -d --rm --name migrate-terminal-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15521:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15521/postgres?sslmode=disable" \
