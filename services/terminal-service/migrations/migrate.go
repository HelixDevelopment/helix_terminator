// Package migrations embeds terminal-service's SQL schema migrations and
...
//     own tables (e.g. this service's "terminal_sessions"), which
...
// (<service>_service, e.g. auth_service, terminal_service) -
...
// regression.
const migrationsTable = "terminal_service_schema_migrations"
