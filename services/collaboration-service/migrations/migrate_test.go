...
// To run for real:
//
//	podman run -d --rm --name migrate-collaboration-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15531:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15531/postgres?sslmode=disable" \
