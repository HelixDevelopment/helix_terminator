...
// To run for real:
//
//	podman run -d --rm --name migrate-billing-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15542:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15542/postgres?sslmode=disable" \
