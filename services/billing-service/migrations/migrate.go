// Package migrations embeds billing-service's SQL schema migrations and
...
//
// This package is purely additive schema setup for billing-service's
// plans/subscriptions/invoices/usage-records tables; it does not touch
// this service's auth-middleware or tenant-scoping handler/model logic
// (T12/T14).
package migrations
...
// regression.
const migrationsTable = "billing_service_schema_migrations"
