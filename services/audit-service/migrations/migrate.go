// Package migrations embeds audit-service's SQL schema migrations and
...
//     own tables (audit-service declares "audit_logs" + its indexes),
...
// regression.
const migrationsTable = "audit_service_schema_migrations"
