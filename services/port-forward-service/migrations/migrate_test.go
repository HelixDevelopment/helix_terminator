...
// To run for real:
//
//	podman run -d --rm --name migrate-port-forward-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15544:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15544/postgres?sslmode=disable" \
...
func TestRun_Integration(t *testing.T) {
	...
	const wantVersion = 2 // highest embedded migration version (001_init + 002_add_tunnel_fields)
