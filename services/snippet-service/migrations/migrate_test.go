...
// To run for real:
//
//	podman run -d --rm --name migrate-snippet-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15513:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15513/postgres?sslmode=disable" \
