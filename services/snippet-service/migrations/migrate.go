// Package migrations embeds snippet-service's SQL schema migrations and
...
//     own tables (snippet-service declares "snippets" + its indexes),
//     which collide the instant a second service's migrator runs
//     against the shared database ("relation already exists").
//
...
// regression.
const migrationsTable = "snippet_service_schema_migrations"
