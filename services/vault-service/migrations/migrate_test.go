...
// To run for real:
//
//	podman run -d --rm --name migrate-vault-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15524:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15524/postgres?sslmode=disable" \
