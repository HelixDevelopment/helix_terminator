...
// To run for real:
//
//	podman run -d --rm --name migrate-container-bridge-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15533:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15533/postgres?sslmode=disable" \
