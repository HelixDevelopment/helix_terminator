// Package migrations embeds notification-service's SQL schema migrations
// and applies them to PostgreSQL at process startup using golang-migrate
...
// regression.
const migrationsTable = "notification_service_schema_migrations"
