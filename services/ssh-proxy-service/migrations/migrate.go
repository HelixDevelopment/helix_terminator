// Package migrations embeds ssh-proxy-service's SQL schema migrations and
...
//     own tables (ssh-proxy-service declares "ssh_sessions" +
//     "ssh_channels" plus their indexes), which collide the instant a
...
const Schema = "ssh_proxy_service"
...
// regression.
const migrationsTable = "ssh_proxy_service_schema_migrations"
