// Package migrations embeds host-service's SQL schema migrations and
...
//     own tables (host-service declares "hosts" + "host_connection_logs"
//     plus the "auth_type"/"connection_status" enum types and the
//     update_hosts_updated_at() trigger function), which collide the
...
// regression.
const migrationsTable = "host_service_schema_migrations"
