...
// To run for real:
//
//	podman run -d --rm --name migrate-host-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15511:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15511/postgres?sslmode=disable" \
