...
// To run for real:
//
//	podman run -d --rm --name migrate-it-user -e POSTGRES_PASSWORD=postgres \
//	  -p 15502:5432 docker.io/library/postgres:17.2
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15502/postgres?sslmode=disable" \
