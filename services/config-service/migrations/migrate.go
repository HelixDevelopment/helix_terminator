// Package migrations embeds config-service's SQL schema migrations and
...
//     own tables (config-service declares "configs" + its indexes and
//     the update_updated_at_column() trigger function), which collide
...
// regression.
const migrationsTable = "config_service_schema_migrations"
