...
// To run for real:
//
//	podman run -d --rm --name migrate-ai-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15534:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15534/postgres?sslmode=disable" \
