...
// To run for real:
//
//	podman run -d --rm --name migrate-sftp-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15512:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15512/postgres?sslmode=disable" \
