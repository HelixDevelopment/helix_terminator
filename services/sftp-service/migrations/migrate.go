// Package migrations embeds sftp-service's SQL schema migrations and
...
//     own tables (sftp-service declares "sftp_sessions" + its indexes),
...
// regression.
const migrationsTable = "sftp_service_schema_migrations"
