...
import (
	...
	"github.com/helixdevelopment/sftp-service/migrations"
)
...
// via rootless podman, applies sftp-service migrations, and returns a
// schema-scoped DATABASE_URL ready for pgxpool.New. The container is
...
func StartTestPostgres(t *testing.T) (dbURL string, available bool) {
	...
	name := fmt.Sprintf("sftp-stress-%d", time.Now().UnixNano())
