// Package migrations embeds recording-service's SQL schema migrations and
...
//     own tables (e.g. this service's "recordings"), which collide the
...
// (<service>_service, e.g. auth_service, recording_service) -
...
const Schema = "recording_service"
...
// regression.
const migrationsTable = "recording_service_schema_migrations"
