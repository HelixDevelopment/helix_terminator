...
// To run for real:
//
//	podman run -d --rm --name migrate-pki-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15523:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15523/postgres?sslmode=disable" \
