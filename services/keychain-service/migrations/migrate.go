// Package migrations embeds keychain-service's SQL schema migrations and
...
//
// Scope note: this package touches SCHEMA INIT ONLY (table/index/trigger
// DDL for keychain_items). keychain-service encrypts private_key +
// passphrase at rest (see internal/crypto, T10 remediation) - this
// migrator does not read, write, or reason about that ciphertext in any
// way; it is a pure DDL-application concern, orthogonal to the
...
// (<service>_service, e.g. auth_service, keychain_service) -
...
// regression.
const migrationsTable = "keychain_service_schema_migrations"
