...
// To run for real:
//
//	podman run -d --rm --name migrate-keychain-pg -e POSTGRES_PASSWORD=postgres \
//	  -p 15532:5432 docker.io/library/postgres:17
//	TEST_DATABASE_URL="postgres://postgres:postgres@localhost:15532/postgres?sslmode=disable" \
