...
- [x] T001 Verify `submodules/herald` + nested submodules are populated in this
...
- [x] T002 Write the verification harness
...
- [x] T003 Execute the harness on the UNFIXED tree and confirm it is RED for
...
- [x] T004 [US1] Run `GOWORK=off go mod tidy` in
...
- [x] T005 [US1] Update the explanatory comment block in
...
- [x] T006 [US1] Re-run the T002 harness: module-mode matrix (build/vet/test +
...
- [x] T007 [US2] Rewrite `services/notification-service/Dockerfile` for
      ...
      context requirement
- [x] T008 [US2] Run the harness's container leg: mechanical reachability check
...
- [x] T009 Full harness run end-to-end (all legs) GREEN; save
