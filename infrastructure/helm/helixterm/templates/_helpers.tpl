...
{{/*
Service fullname helper: release-chart-serviceName
*/}}
{{- define "helixterm.serviceFullname" -}}
{{- $serviceName := .serviceName }}
{{- printf "%s-%s" (include "helixterm.fullname" .root) $serviceName | trunc 63 | trimSuffix "-" }}
{{- end }}
